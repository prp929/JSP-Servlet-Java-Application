            ...
            <div>
                ...
                <div class="container searchContainer">
                    <div class="search card card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/CompanyInfoSearchServlet"  method="post">
                            ...
                            <fieldset class="form-group d-flex justify-content-start" >
                                ...
                                <select name="tableName" class="mx-3">
                                    ...
                                    <option value="sector">Sector Info</option>
                                </select>
                            </fieldset>
                            <hr>
                            ...
                            <div class="form-group d-flex justify-content-start pl-5" >
                                ...
                                <fieldset>
                                    <select name="colName1" id="colName1" class="mx-3">
                                            ...
                                            <option value="price_earnings_ratio">Price/Earnings Ratio</option>
                                            <option value="dividend_yield">Dividend Yield</option>
                                            <option value="earnings_share">Earnings Share</option>
                                            <option value="year_low">Year Low</option>
                                            <option value="year_high">Year High</option>
                                            <option value="market_cap">Market Cap</option>
                                            <option value="ebitda">EBITDA</option>
                                            <option value="price_sales_ratio">Price/Sales Ratio</option>
                                            <option value="price_book_ratio">Price/Book Ratio</option>
                                            <option value="sec_filing_link">SEC Filing Link</option>
                                    </select>
                                </fieldset>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-start pl-5" >
                                <label> Sector Info Option: </label>
                                <fieldset>
                        ...
                        <div class="results">
                                ...
                                <% ArrayList<String> list = null; int i = 0;
                                    if(session.getAttribute("companyInfoResults") != null) {
                                        list = (ArrayList<String>) session.getAttribute("companyInfoResults");
