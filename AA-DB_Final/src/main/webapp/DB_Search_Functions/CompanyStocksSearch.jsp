            ...
            <div>
                ...
                <div class="container searchContainer">
                    <div class="search card card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/CompanyStockSearchServlet"  method="post">
                            ...
                            <fieldset class="form-group d-flex justify-content-start" >
                                <label class="mx-3">1. Select a Company: </label>
                                <select name="tableName" class="mx-3">
                                    ...
                                    <option value="rtx">Raytheon</option>
                                    <option value="tsla">Tesla</option>
                                </select>
                            </fieldset>
                            <hr>

                            <label class="mx-3">2. Select the values you want to search: </label>
                            <br> <br>
                        ...
                        <div class="results">
                            ...
                            <% ArrayList<String> list = null; int i = 0;
                                if(session.getAttribute("stockResults") != null) {
                                    list = (ArrayList<String>) session.getAttribute("stockResults");
